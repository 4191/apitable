            ...
            {groupByTableData?.map?.((item, idx) => (
              <>
                <div key={idx + 'hidden'} className={classNames(styles.pBar)}>
                  ...
                  <span>{item[GroupBy]}</span>
                  {/* <span>{item[yylyfl]?.split('|')?.[0] ?? item[yylyfl]}</span> */}
                ...
                {!item.hiddenContent && (
                  <div key={idx} className={classNames(styles.pWrap)}>
                    <div className={classNames(styles.pHeader)}>
                      <div className={classNames(styles.pNumber)}>{item[Col2]}</div>

                      <div className={classNames(styles.pTitle)}>{item[Col1]}</div>
                    </div>
                    <div className={classNames(styles.pConctent)}>{item[Col3]}</div>
                  </div>
                )}
              </>
            ))}
